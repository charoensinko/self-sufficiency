...
วิธีง่ายสุด: **ดับเบิลคลิก `backup.bat`** ที่รากโปรเจกต์ (หน้าต่างค้างไว้ให้อ่านผลจนกด
ปุ่มใดๆ) หรือรันเองใน terminal:
...
4. กู้ข้อมูล — **ดับเบิลคลิก `restore.bat`** (สคริปต์จะโชว์รายการ backup ให้เลือก
   แล้วถามยืนยันด้วยการพิมพ์ YES) หรือรันเองแบบระบุโฟลเดอร์:
   ```bash
